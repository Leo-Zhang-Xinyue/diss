...
def model_config(parser):
    ...
    parser.add_argument('--shared_size', type = int, default = 256)
...
def main():
    ...
    for dataset in args.train_datasets:
        ...
        train_data = BatchGen(BatchGen.load(train_path, True, pairwise=pw_task),
    ...
    model = MTDNNModel(opt, args, state_dict=state_dict, num_train_step=num_all_batches)
    ####model meta str
